...
import cti.app.controller.Tab03_FindFileController;
import cti.app.service.AppTimer;
import cti.app.service.Tab03_FindFileService;

public class Tab03_FindFileView extends Tab03_FindFileConstant {

	private static JPanelSimple jp = new JPanelSimple();
	public static Tab03_FindFileService fs = new Tab03_FindFileService();
