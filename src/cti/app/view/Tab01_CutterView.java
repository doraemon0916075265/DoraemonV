...
import cti.app.controller.Tab01_CutterController;
import cti.app.service.AppTimer;

public class Tab01_CutterView extends Tab01_CutterConstant {
	...
	private static void setListener() {
		...
		jb_guideBook.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent ae) {
				...
				JOptionPane.showMessageDialog(null, Tab01_CutterController.guidebook(), APP_GUIDEBOOK_TITLE, JOptionPane.DEFAULT_OPTION);
