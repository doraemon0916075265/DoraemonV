...
public class Test3 extends JPanel {
	...
	public static Test3 getInstance(Date date) {
		return new Test3(date);
	}

	public static Test3 getInstance(String format) {
		return new Test3(format);
	}

	public static Test3 getInstance(Date date, String format) {
		return new Test3(date, format);
	}
	...
	private Test3(Date date) {
		this(date, "yyyy年MM月dd日");
	}

	private Test3(String format) {
		this(new Date(), format);
	}

	private Test3(Date date, String format) {
		initDate = date;
	...
	public static void main(String[] args) {
		Test3 dateChooser1 = Test3.getInstance("yyyy-MM-dd");
		Test3 dateChooser2 = Test3.getInstance("yyyy-MM-dd");
